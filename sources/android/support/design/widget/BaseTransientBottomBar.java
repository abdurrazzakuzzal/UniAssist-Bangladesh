...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            if (a.hasValue(C0020R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0020R.styleable.SnackbarLayout_elevation, 0));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0020R.layout.design_layout_snackbar, this.mTargetParent, false);
    ...
    public void animateViewIn() {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0020R.anim.design_snackbar_in);
    ...
    private void animateViewOut(final int event) {
        ...
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0020R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new AnimationListener() {
            public void onAnimationEnd(Animation animation) {
