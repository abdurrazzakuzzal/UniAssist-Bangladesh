...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo60to = 1000) int weight, boolean italic, int resultCode) {
                ...
                sBackgroundThread.postAndReply(fetcher, new ReplyCallback<Typeface>() {
                    public void onReply(Typeface typeface) {
                        ...
                        synchronized (FontsContractCompat.sLock) {
                            arrayList = (ArrayList) FontsContractCompat.sPendingReplies.get(id);
            ...
            if (cursor2 != null && cursor2.getCount() > 0) {
                ...
                while (cursor2.moveToNext()) {
                    ...
                    if (italicColumnIndex != -1) {
                        if (cursor2.getInt(italicColumnIndex) == 1) {
                            italic = true;
