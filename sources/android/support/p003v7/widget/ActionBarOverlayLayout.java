...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0336R.attr.actionBarSize, 16842841};
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (i < count2) {
            ...
            if (child.getVisibility() != 8) {
                ...
                child.layout(childLeft, count3, childLeft + child.getMeasuredWidth(), count3 + child.getMeasuredHeight());
            } else {
                count = count2;
                parentLeft = parentLeft2;
            }
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0336R.C0338id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0336R.C0338id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0336R.C0338id.action_bar));
        }
    }
