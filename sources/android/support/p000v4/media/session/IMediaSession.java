...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        /* JADX WARNING: type inference failed for: r1v5, types: [android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper] */
        /* JADX WARNING: type inference failed for: r1v8, types: [android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper] */
        /* JADX WARNING: type inference failed for: r1v9 */
        /* JADX WARNING: type inference failed for: r0v15, types: [android.view.KeyEvent] */
        /* JADX WARNING: type inference failed for: r1v12, types: [android.view.KeyEvent] */
        /* JADX WARNING: type inference failed for: r1v19, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v22, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v23, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v26, types: [android.os.Bundle] */
        ...
        /* JADX WARNING: type inference failed for: r0v60, types: [android.support.v4.media.RatingCompat] */
        /* JADX WARNING: type inference failed for: r1v33, types: [android.support.v4.media.RatingCompat] */
        /* JADX WARNING: type inference failed for: r1v34, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v37, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v46, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v49, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v50, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v53, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v54, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v57, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r1v60 */
        /* JADX WARNING: type inference failed for: r0v91, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r1v62, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r1v63 */
        /* JADX WARNING: type inference failed for: r0v96, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r1v66, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r1v67 */
        /* JADX WARNING: type inference failed for: r0v101, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r1v69, types: [android.support.v4.media.MediaDescriptionCompat] */
        ...
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r1v0
          ...
          uses: [android.os.Bundle, android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper, ?[OBJECT, ARRAY]]
          mth insns count: 436
        ...
        public boolean onTransact(int r6, android.os.Parcel r7, android.os.Parcel r8, int r9) throws android.os.RemoteException {
            ...
            L_0x00c6:
                ...
                r0 = 1
            L_0x00d3:
                r5.setShuffleModeEnabledDeprecated(r0)
                r8.writeNoException()
                return r2
            L_0x00da:
                java.lang.String r0 = "android.support.v4.media.session.IMediaSession"
