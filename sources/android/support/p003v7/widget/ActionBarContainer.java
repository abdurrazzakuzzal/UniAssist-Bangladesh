...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0336R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0336R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0336R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0336R.styleable.ActionBar_height, -1);
        if (getId() == C0336R.C0338id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0336R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0336R.C0338id.action_bar);
        this.mContextView = findViewById(C0336R.C0338id.action_context_bar);
    }
