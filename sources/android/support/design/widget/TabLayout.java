...
public class TabLayout extends HorizontalScrollView {
        ...
        public void animateIndicatorToPosition(int position, int duration) {
            ...
            if (Math.abs(i - this.mSelectedPosition) <= 1) {
                ...
                if (i < this.mSelectedPosition) {
                    if (isRtl) {
                        startRight2 = targetLeft - offset;
                        startRight3 = startRight2;
                    } else {
                        startRight2 = targetRight + offset;
                        startRight3 = startRight2;
                    }
                } else if (isRtl) {
                    startRight2 = targetRight + offset;
                ...
                startRight = startRight3;
            }
            int startLeft2 = startRight2;
            if (startLeft2 == targetLeft && startRight == targetRight) {
                int i2 = duration;
                boolean z = isRtl;
            } else {
    ...
    class TabView extends LinearLayout {
        ...
        public final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0020R.layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0020R.layout.design_layout_tab_text, this, false);
                    addView(textView);
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0020R.styleable.TabLayout, defStyleAttr, C0020R.style.Widget_Design_TabLayout);
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0020R.styleable.TabLayout_tabIndicatorColor, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabPadding, 0);
        this.mTabPaddingBottom = dimensionPixelSize;
        this.mTabPaddingEnd = dimensionPixelSize;
        this.mTabPaddingTop = dimensionPixelSize;
        this.mTabPaddingStart = dimensionPixelSize;
        this.mTabPaddingStart = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabPaddingStart, this.mTabPaddingStart);
        this.mTabPaddingTop = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabPaddingTop, this.mTabPaddingTop);
        this.mTabPaddingEnd = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabPaddingEnd, this.mTabPaddingEnd);
        this.mTabPaddingBottom = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabPaddingBottom, this.mTabPaddingBottom);
        this.mTabTextAppearance = a.getResourceId(C0020R.styleable.TabLayout_tabTextAppearance, C0020R.style.TextAppearance_Design_Tab);
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0336R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0336R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0336R.styleable.TextAppearance_android_textColor);
            ta.recycle();
            if (a.hasValue(C0020R.styleable.TabLayout_tabTextColor)) {
                this.mTabTextColors = a.getColorStateList(C0020R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0020R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0020R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = a.getResourceId(C0020R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = a.getDimensionPixelSize(C0020R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = a.getInt(C0020R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = a.getInt(C0020R.styleable.TabLayout_tabGravity, 0);
            a.recycle();
            Resources res = getResources();
            this.mTabTextMultiLineSize = (float) res.getDimensionPixelSize(C0020R.dimen.design_tab_text_size_2line);
            this.mScrollableTabMinWidth = res.getDimensionPixelSize(C0020R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } catch (Throwable th) {
            ta.recycle();
            throw th;
