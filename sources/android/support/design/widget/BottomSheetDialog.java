...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0020R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0020R.C0022id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0020R.C0022id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0020R.C0022id.touch_outside).setOnClickListener(new OnClickListener() {
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0020R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0020R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
