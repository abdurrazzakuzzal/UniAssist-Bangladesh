        ...
        private class StubApi21 implements Callback {
            ...
            public void onCommand(java.lang.String r6, android.os.Bundle r7, android.os.ResultReceiver r8) {
                /*
                    ...
                    boolean r0 = r6.equals(r0)     // Catch:{ BadParcelableException -> 0x00e6 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0036
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.p000v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e6 }
                    java.lang.ref.WeakReference r0 = r0.mSessionImpl     // Catch:{ BadParcelableException -> 0x00e6 }
                    java.lang.Object r0 = r0.get()     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r0 = (android.support.p000v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r0     // Catch:{ BadParcelableException -> 0x00e6 }
                    if (r0 == 0) goto L_0x0034
                    android.os.Bundle r2 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00e6 }
                    r2.<init>()     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.session.MediaSessionCompat$Token r3 = r0.getSessionToken()     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.session.IMediaSession r3 = r3.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00e6 }
                    java.lang.String r4 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r3 != 0) goto L_0x0029
                    goto L_0x002d
                L_0x0029:
                    android.os.IBinder r1 = r3.asBinder()     // Catch:{ BadParcelableException -> 0x00e6 }
                L_0x002d:
                    android.support.p000v4.app.BundleCompat.putBinder(r2, r4, r1)     // Catch:{ BadParcelableException -> 0x00e6 }
                    r1 = 0
                    r8.send(r1, r2)     // Catch:{ BadParcelableException -> 0x00e6 }
                L_0x0034:
                    goto L_0x00e5
                L_0x0036:
                    ...
                    java.lang.Class<android.support.v4.media.MediaDescriptionCompat> r0 = android.support.p000v4.media.MediaDescriptionCompat.class
                    java.lang.ClassLoader r0 = r0.getClassLoader()     // Catch:{ BadParcelableException -> 0x00e6 }
                    r7.setClassLoader(r0)     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.p000v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e6 }
                    java.lang.String r1 = "android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION"
                    android.os.Parcelable r1 = r7.getParcelable(r1)     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.p000v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00e6 }
                    r0.onAddQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00e6 }
                    goto L_0x00e5
                L_0x0056:
                    ...
                    int r2 = r7.getInt(r2)     // Catch:{ BadParcelableException -> 0x00e6 }
                    r0.onAddQueueItem(r1, r2)     // Catch:{ BadParcelableException -> 0x00e6 }
                    goto L_0x00e5
                L_0x007b:
                    ...
                    android.os.Parcelable r1 = r7.getParcelable(r1)     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.p000v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00e6 }
                    r0.onRemoveQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00e6 }
                    goto L_0x00e5
                L_0x009a:
                    ...
                    java.util.List r2 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00e6 }
                    if (r2 == 0) goto L_0x00df
                    java.lang.String r2 = "android.support.v4.media.session.command.ARGUMENT_INDEX"
                    r3 = -1
                    int r2 = r7.getInt(r2, r3)     // Catch:{ BadParcelableException -> 0x00e6 }
                    if (r2 < 0) goto L_0x00d4
                    java.util.List r3 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00e6 }
                    int r3 = r3.size()     // Catch:{ BadParcelableException -> 0x00e6 }
                    if (r2 >= r3) goto L_0x00d4
                    java.util.List r1 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00e6 }
                    java.lang.Object r1 = r1.get(r2)     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.p000v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00e6 }
                L_0x00d4:
                    if (r1 == 0) goto L_0x00df
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.p000v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e6 }
                    android.support.v4.media.MediaDescriptionCompat r4 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00e6 }
                    r3.onRemoveQueueItem(r4)     // Catch:{ BadParcelableException -> 0x00e6 }
                L_0x00df:
                    goto L_0x00e5
                L_0x00e0:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.p000v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00e6 }
                    r0.onCommand(r6, r7, r8)     // Catch:{ BadParcelableException -> 0x00e6 }
                L_0x00e5:
                    goto L_0x00ee
                L_0x00e6:
                    r0 = move-exception
