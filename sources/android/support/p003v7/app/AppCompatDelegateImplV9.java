...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0336R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0336R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0336R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0336R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0336R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0336R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0336R.layout.abc_list_menu_item_layout);
    ...
    private ViewGroup createSubDecor() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0336R.styleable.AppCompatTheme);
        if (!a.hasValue(C0336R.styleable.AppCompatTheme_windowActionBar)) {
            a.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (a.getBoolean(C0336R.styleable.AppCompatTheme_windowNoTitle, false)) {
            requestWindowFeature(1);
        } else if (a.getBoolean(C0336R.styleable.AppCompatTheme_windowActionBar, false)) {
            requestWindowFeature(108);
        }
        if (a.getBoolean(C0336R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
            requestWindowFeature(109);
        }
        if (a.getBoolean(C0336R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = a.getBoolean(C0336R.styleable.AppCompatTheme_android_windowIsFloating, false);
        a.recycle();
        ...
        if (this.mWindowNoTitle) {
            if (this.mOverlayActionMode) {
                subDecor = (ViewGroup) inflater.inflate(C0336R.layout.abc_screen_simple_overlay_action_mode, null);
            } else {
                subDecor = (ViewGroup) inflater.inflate(C0336R.layout.abc_screen_simple, null);
            }
            subDecor2 = subDecor;
            if (VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(subDecor2, new OnApplyWindowInsetsListener() {
                ...
                ((FitWindowsViewGroup) subDecor2).setOnFitSystemWindowsListener(new OnFitSystemWindowsListener() {
            ...
            subDecor2 = (ViewGroup) inflater.inflate(C0336R.layout.abc_dialog_title_material, null);
            this.mOverlayActionBar = false;
            this.mHasActionBar = false;
        } else if (this.mHasActionBar) {
            TypedValue outValue = new TypedValue();
            this.mContext.getTheme().resolveAttribute(C0336R.attr.actionBarTheme, outValue, true);
            if (outValue.resourceId != 0) {
                themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
            } else {
                themedContext = this.mContext;
            }
            subDecor2 = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0336R.layout.abc_screen_toolbar, null);
            this.mDecorContentParent = (DecorContentParent) subDecor2.findViewById(C0336R.C0338id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) subDecor2.findViewById(C0336R.C0338id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor2);
        ContentFrameLayout contentView = (ContentFrameLayout) subDecor2.findViewById(C0336R.C0338id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0336R.styleable.AppCompatTheme);
        a.getValue(C0336R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0336R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0336R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0336R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0336R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0336R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0336R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0336R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0336R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0336R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0336R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext2, null, C0336R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext2.getTheme().resolveAttribute(C0336R.attr.actionBarSize, outValue, true);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0336R.C0338id.action_mode_bar_stub);
                    if (stub != null) {
        ...
        if (!panelFeatureState.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(width, -2, panelFeatureState.f29x, panelFeatureState.f30y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0336R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0336R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != (localInsets.top == 0 ? insetTop : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0336R.color.abc_input_method_navigation_guard));
