...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0339R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0339R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0339R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0339R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0339R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public final class Recycler {
            ...
            if (this.mChangedScrap != null) {
                ...
                if (size != 0) {
                    ...
                    while (i2 < changedScrapSize) {
                        ViewHolder holder = (ViewHolder) this.mChangedScrap.get(i2);
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            while (i < cacheSize) {
                ViewHolder holder2 = (ViewHolder) this.mCachedViews.get(i);
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedScroll(hresult, vresult3, overscrollX2, overscrollY2, null, 1)) {
                ...
                if (!(hresult == 0 && vresult3 == 0)) {
                    RecyclerView.this.dispatchOnScrolled(hresult, vresult3);
                }
                if (!RecyclerView.this.awakenScrollBars()) {
                    RecyclerView.this.invalidate();
                }
                boolean fullyConsumedAny = (dx == 0 && dy == 0) || (dx != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx) || (dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && vresult3 == dy);
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0339R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0339R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0339R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a2.getBoolean(C0339R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0339R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0339R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0339R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0339R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0339R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0339R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0339R.dimen.fastscroll_margin));
    }
