...
public class ConstraintLayout extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        private static class Table {
            ...
            static {
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintCircle, 2);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                map.append(C0008R.styleable.ConstraintLayout_Layout_android_orientation, 1);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                map.append(C0008R.styleable.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public LayoutParams(android.content.Context r20, android.util.AttributeSet r21) {
            /*
                ...
                r1.widget = r3
                r1.helped = r4
                int[] r3 = android.support.constraint.C0008R.styleable.ConstraintLayout_Layout
                r6 = r20
                r8 = r21
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, C0008R.styleable.ConstraintLayout_Layout);
            int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                if (attr == C0008R.styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.mMinWidth = a.getDimensionPixelOffset(attr, this.mMinWidth);
                } else if (attr == C0008R.styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.mMinHeight = a.getDimensionPixelOffset(attr, this.mMinHeight);
                } else if (attr == C0008R.styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.mMaxWidth = a.getDimensionPixelOffset(attr, this.mMaxWidth);
                } else if (attr == C0008R.styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.mMaxHeight = a.getDimensionPixelOffset(attr, this.mMaxHeight);
                } else if (attr == C0008R.styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.mOptimizationLevel = a.getInt(attr, this.mOptimizationLevel);
                } else if (attr == C0008R.styleable.ConstraintLayout_Layout_constraintSet) {
                    ...
                    if (params2.isGuideline) {
                        ...
                        if (width3 == 0 || height3 == 0) {
                            ...
                            if (width3 != 0 || height3 != 0 || !bothHorizontal || !bothVertical) {
                                ...
                                widgetsCount = widgetsCount6;
                                boolean resolveWidth2 = this.mLayoutWidget.getHorizontalDimensionBehaviour() != DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                                i2 = i6;
                                boolean resolveHeight2 = this.mLayoutWidget.getVerticalDimensionBehaviour() != DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                                if (!resolveWidth2) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:185:0x03bb  */
    /* JADX WARNING: Removed duplicated region for block: B:188:0x03e7  */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onMeasure(int r57, int r58) {
        /*
            r56 = this;
            r0 = r56
            r1 = r57
            ...
            r5 = 0
            r6 = 0
            int r7 = android.view.View.MeasureSpec.getMode(r57)
            int r8 = android.view.View.MeasureSpec.getSize(r57)
            int r9 = android.view.View.MeasureSpec.getMode(r58)
            int r10 = android.view.View.MeasureSpec.getSize(r58)
        ...
        L_0x007f:
            ...
            int r4 = r56.getPaddingLeft()
            r20 = r3
            int r3 = r56.getPaddingTop()
            r21 = r5
        ...
        L_0x00c5:
            ...
            r7 = 1
        L_0x00c8:
            r56.setSelfDimensionBehaviour(r57, r58)
            android.support.constraint.solver.widgets.ConstraintWidgetContainer r5 = r0.mLayoutWidget
            int r5 = r5.getWidth()
        ...
        L_0x00ef:
            ...
            r56.internalMeasureDimensions(r57, r58)
            goto L_0x0102
        L_0x00ff:
            r56.internalMeasureChildren(r57, r58)
        L_0x0102:
            r56.updatePostMeasures()
            int r8 = r56.getChildCount()
        ...
        L_0x0110:
            ...
            int r8 = r8.size()
            int r16 = r56.getPaddingBottom()
            r28 = r9
            int r9 = r3 + r16
            int r16 = r56.getPaddingRight()
            r29 = r3
            int r3 = r4 + r16
            r30 = r4
        ...
        L_0x01d3:
            ...
            r45 = r11
            r11 = -2
            if (r5 != r11) goto L_0x01e9
            boolean r5 = r6.horizontalDimensionFixed
            if (r5 == 0) goto L_0x01e9
            int r5 = r6.width
            int r5 = getChildMeasureSpec(r1, r3, r5)
            goto L_0x01f3
        L_0x01e9:
            int r5 = r15.getWidth()
        ...
        L_0x020d:
            ...
            android.support.constraint.solver.Metrics r11 = r0.mMetrics
            r46 = r1
            long r1 = r11.additionalMeasures
            r48 = r5
            r47 = r6
            long r5 = r1 + r37
            r11.additionalMeasures = r5
            goto L_0x0229
        L_0x0223:
            r46 = r1
            r48 = r5
        ...
        L_0x0293:
            r5 = r47
            boolean r6 = r5.needsBaseline
            if (r6 == 0) goto L_0x02ab
            int r6 = r8.getBaseline()
            r11 = -1
            if (r6 == r11) goto L_0x02ab
            int r11 = r15.getBaselineDistance()
            if (r6 == r11) goto L_0x02ab
        ...
        L_0x02ab:
            ...
            r11 = 11
            if (r6 < r11) goto L_0x02bc
            int r6 = r8.getMeasuredState()
            int r14 = combineMeasuredStates(r14, r6)
            goto L_0x02bc
        L_0x02ba:
            r43 = r11
        L_0x02bc:
