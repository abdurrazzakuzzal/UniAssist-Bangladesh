...
import android.support.constraint.C0008R.C0009id;
...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0008R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
    ...
    private void addID(String idString) {
        if (idString != null && this.myContext != null) {
            ...
            int tag = 0;
            try {
                tag = C0009id.class.getField(idString2).getInt(null);
            } catch (Exception e) {
            }
            if (tag == 0) {
