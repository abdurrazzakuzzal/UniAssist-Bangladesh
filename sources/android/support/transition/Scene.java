...
public class Scene {
    ...
    public static Scene getSceneForLayout(@NonNull ViewGroup sceneRoot, @LayoutRes int layoutId, @NonNull Context context) {
        SparseArray sparseArray = (SparseArray) sceneRoot.getTag(C0117R.C0119id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            sceneRoot.setTag(C0117R.C0119id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0117R.C0119id.transition_current_scene, scene);
    }

    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0117R.C0119id.transition_current_scene);
    }
