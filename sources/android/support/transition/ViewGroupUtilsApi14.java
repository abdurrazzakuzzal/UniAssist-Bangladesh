...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    public void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0117R.C0119id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0117R.C0119id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0117R.C0119id.transition_layout_save, null);
