...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0020R.styleable.SnackbarLayout);
        this.mMaxWidth = a.getDimensionPixelSize(C0020R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = a.getDimensionPixelSize(C0020R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        a.recycle();
    }
    ...
    public void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0020R.C0022id.snackbar_text);
        this.mActionView = (Button) findViewById(C0020R.C0022id.snackbar_action);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int multiLineVPadding = getResources().getDimensionPixelSize(C0020R.dimen.design_snackbar_padding_vertical_2lines);
        int singleLineVPadding = getResources().getDimensionPixelSize(C0020R.dimen.design_snackbar_padding_vertical);
