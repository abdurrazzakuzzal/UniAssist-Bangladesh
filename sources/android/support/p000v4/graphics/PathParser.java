...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path p, float x0, float y0, float x1, float y1, float a, float b, float theta, boolean isMoreThanHalf, boolean isPositiveArc) {
            ...
            double d9 = sdy;
            float f9 = a;
            double cx2 = cx * ((double) f9);
            float f10 = b;
            double cy2 = cy * ((double) f10);
            double tcx = cx2;
            double d10 = tcx;
            arcToBezier(p, (cx2 * cosTheta) - (cy2 * sinTheta), (tcx * sinTheta) + (cy2 * cosTheta), (double) f9, (double) f10, (double) f, (double) f2, thetaD2, eta0, sweep);
        }
