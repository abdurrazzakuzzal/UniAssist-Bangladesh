...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void unregisterCallback(android.support.p000v4.media.session.MediaControllerCompat.Callback r4) {
            /*
                ...
                android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback r0 = (android.support.p000v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback) r0     // Catch:{ RemoteException -> 0x001d }
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            PlaybackInfo playbackInfo = new PlaybackInfo(android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getPlaybackType(volumeInfoObj), android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(volumeInfoObj), android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getVolumeControl(volumeInfoObj), android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getMaxVolume(volumeInfoObj), android.support.p000v4.media.session.MediaControllerCompatApi21.PlaybackInfo.getCurrentVolume(volumeInfoObj));
            return playbackInfo;
        }
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void setRating(RatingCompat rating) {
            android.support.p000v4.media.session.MediaControllerCompatApi21.TransportControls.setRating(this.mControlsObj, rating != null ? rating.getRating() : null);
        }
        ...
        public void sendCustomAction(CustomAction customAction, Bundle args) {
            ...
            android.support.p000v4.media.session.MediaControllerCompatApi21.TransportControls.sendCustomAction(this.mControlsObj, customAction.getAction(), args);
        }
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        public void playFromUri(Uri uri, Bundle extras) {
            android.support.p000v4.media.session.MediaControllerCompatApi23.TransportControls.playFromUri(this.mControlsObj, uri, extras);
        }
    }
    ...
    static class TransportControlsApi24 extends TransportControlsApi23 {
        ...
        public void prepareFromUri(Uri uri, Bundle extras) {
            android.support.p000v4.media.session.MediaControllerCompatApi24.TransportControls.prepareFromUri(this.mControlsObj, uri, extras);
        }
    }
