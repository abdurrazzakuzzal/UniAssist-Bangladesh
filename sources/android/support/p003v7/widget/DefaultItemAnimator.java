...
public class DefaultItemAnimator extends SimpleItemAnimator {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (additionsPending) {
                ...
                if (removalsPending || movesPending || changesPending) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) additions.get(0)).itemView, adder, removeDuration + Math.max(moveDuration, changeDuration));
                } else {
                    adder.run();
    ...
    public void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        C03816 r0 = new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
