...
class FloatingActionButtonImpl {
    ...
    public void setBackgroundDrawable(ColorStateList backgroundTint, Mode backgroundTintMode, int rippleColor, int borderWidth) {
        ...
        ShadowDrawableWrapper shadowDrawableWrapper = new ShadowDrawableWrapper(this.mView.getContext(), this.mContentBackground, this.mShadowViewDelegate.getRadius(), this.mElevation, this.mPressedTranslationZ + this.mElevation);
    ...
    public CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0020R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0020R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0020R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0020R.color.design_fab_stroke_end_outer_color));
