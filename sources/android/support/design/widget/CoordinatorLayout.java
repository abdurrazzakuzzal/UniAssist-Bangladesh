...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0020R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0020R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0020R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0020R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0020R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0020R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0020R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0020R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0020R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0020R.styleable.CoordinatorLayout, defStyleAttr, C0020R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0020R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0020R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public final void onChildViewsChanged(int type) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (i != 0 || child.getVisibility() != 8) {
                ...
                int j3 = i2 + 1;
                while (j3 < childCount) {
                    View checkChild = (View) this.mDependencySortedChildren.get(j3);
