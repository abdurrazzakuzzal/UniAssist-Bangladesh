...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (!context.getTheme().resolveAttribute(C0336R.attr.actionBarPopupTheme, tv, true) || tv.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0336R.styleable.ActionBar, C0336R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(C0336R.styleable.ActionBar_height, 0));
        a.recycle();
