    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0336R.C0338id.topPanel) {
                    topPanel = child;
                } else if (id == C0336R.C0338id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0336R.C0338id.contentPanel && id != C0336R.C0338id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
        ...
        if (middlePanel == null || remainingHeight <= 0) {
            ...
            middlePanel.measure(i, MeasureSpec.makeMeasureSpec(middleHeight + heightToGive2, i4));
