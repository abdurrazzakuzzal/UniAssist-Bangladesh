...
public class ArgbEvaluator implements TypeEvaluator {
    ...
    public Object evaluate(float fraction, Object startValue, Object endValue) {
        ...
        float f2 = startG2;
        float f3 = startR2;
        return Integer.valueOf((Math.round((((endA - startA) * fraction) + startA) * 255.0f) << 24) | (Math.round(((float) Math.pow((double) (((endR - startR2) * fraction) + startR2), 0.45454545454545453d)) * 255.0f) << 16) | (Math.round(((float) Math.pow((double) (((((float) Math.pow((double) (((float) ((endInt >> 8) & 255)) / 255.0f), 2.2d)) - startG2) * fraction) + startG2), 0.45454545454545453d)) * 255.0f) << 8) | Math.round(((float) Math.pow((double) (((((float) Math.pow((double) endB, 2.2d)) - startB2) * fraction) + startB2), 0.45454545454545453d)) * 255.0f));
    }
}
